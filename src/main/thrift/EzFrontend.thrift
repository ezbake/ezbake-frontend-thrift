...
namespace java ezbake.frontend.thrift
namespace cpp ezbake.frontend.thrift
namespace py ezbake.frontend.thrift
namespace rb EzFrontendThrift
namespace js ezfrontendthrift
...
service EzFrontendService extends EzReverseProxy.EzReverseProxy {
  ...
  bool serverCertsExists(1:string serverName)
}
